    ...
    <div class="container mx-auto px-4">
        <div class="flex space-x-0">
            ...
            <a href="{{ route('dashboard.feedback.index') }}"
                class="menu-item flex items-center space-x-2 px-6 py-4 {{ request()->routeIs('dashboard.feedback.*') ? 'text-white bg-white/20 border-white' : 'text-white/80 hover:text-white hover:bg-white/10' }} transition-all duration-200 border-b-3 border-transparent hover:border-white/50">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
