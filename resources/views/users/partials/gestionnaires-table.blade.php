            ...
            <tr class="user-row hover:bg-gray-50 transition-colors" data-role="{{ $user->role }}"
                        ...
                        <div
                            ...
                            <span class="text-white text-sm font-semibold">
                                ...
                                @php
                                    ...
                                    echo $lastSpace !== false ? substr($user->nom_complet, $lastSpace + 1, 1) : '';
                                @endphp
                            </span>
                        </div>
                        <div class="ml-4">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div class="flex items-center space-x-2 justify-end">
                        <button onclick="openInfoUserModal({{ $user->id }})" class="text-gray-500 hover:text-blue-600 transition-colors" title="Voir les informations">
