...
<head>
    ...
    <div class="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div class="absolute top-40 right-20 w-24 h-24 bg-saar-blue/10 rounded-full animate-float" style="animation-delay: -2s;"></div>
        <div class="absolute bottom-40 left-20 w-20 h-20 bg-saar-green/10 rounded-full animate-float" style="animation-delay: -4s;"></div>
        <div class="absolute bottom-20 right-10 w-28 h-28 bg-red-200/20 rounded-full animate-float" style="animation-delay: -1s;"></div>
    </div>
    ...
    <div class="relative z-10 container mx-auto px-4 py-8">
        ...
        <div class="text-center mb-16 animate-fade-in-up">
            <div class="inline-flex items-center justify-center mb-8">
                <div class="relative">
                    <div class="w-24 h-24 bg-gradient-to-r from-saar-orange to-red-400 rounded-2xl shadow-2xl flex items-center justify-center transform rotate-3 hover:rotate-0 transition-transform duration-500">
            ...
            <h1 class="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-saar-orange via-red-500 to-saar-green mb-4">
                SAAR ASSURANCE
            </h1>
                ...
                <div class="px-8 md:px-12 py-16 text-center">
                    <div class="mb-12">
                        <div class="relative inline-flex items-center justify-center mb-8">
                            <div class="w-20 h-20 bg-gradient-to-r from-green-400 to-saar-green rounded-2xl shadow-xl flex items-center justify-center animate-pulse-slow">
                                <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                </svg>
                            </div>
                            <div class="absolute -top-1 -right-1 w-6 h-6 bg-saar-orange rounded-full animate-ping"></div>
                        </div>
                        ...
                        <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                            Processus simplifié en quelques étapes. Téléchargez vos documents et suivez l'avancement en temps réel.
                        </p>
                    </div>
                    ...
                    <!-- Badge de confiance -->
                    <div class="inline-flex items-center px-4 py-2 bg-green-50 border border-green-200 rounded-full text-green-700 text-sm font-medium">
                ...
                <div class="bg-gradient-to-r from-gray-50 to-red-50/30 px-8 md:px-12 py-10">
                    <div class="grid md:grid-cols-3 gap-8">
                        ...
                        <div class="group text-center hover:transform hover:scale-105 transition-all duration-300">
                            <div class="relative inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-500 to-saar-blue rounded-2xl shadow-lg mb-4 group-hover:shadow-xl">
                                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <div class="absolute -top-1 -right-1 w-4 h-4 bg-saar-orange rounded-full animate-ping"></div>
                            </div>
                        ...
                        <div class="group text-center hover:transform hover:scale-105 transition-all duration-300">
                            <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-saar-green to-green-600 rounded-2xl shadow-lg mb-4 group-hover:shadow-xl">
                                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="group text-center hover:transform hover:scale-105 transition-all duration-300">
                            <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl shadow-lg mb-4 group-hover:shadow-xl">
                                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="px-8 md:px-12 py-12 text-center">
                    <div class="mb-8">
                        <div class="inline-flex items-center justify-center w-16 h-16 bg-white/20 rounded-2xl mb-6">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192L5.636 18.364M12 2.25a9.75 9.75 0 109.75 9.75c0-1.052-.18-2.062-.512-3.011z"></path>
                            </svg>
                        </div>
