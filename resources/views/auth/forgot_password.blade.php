    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                <img class="mx-auto h-16 w-auto" src="{{ asset('logo.png') }}" alt="SAAR Assurances">
            ...
            <form class="mt-8 space-y-6" action="{{ route('password.reset.send.gestionnaire') }}" method="POST">
                @csrf
                <div>
            ...
            <!-- Lien de retour -->
            <div class="text-center">
                <a href="{{ route('login') }}" class="text-sm text-saar-blue hover:text-blue-800 transition-colors duration-200">
